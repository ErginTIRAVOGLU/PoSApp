        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Price = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    ProductUnit = table.Column<decimal>(type: "decimal(18,3)", nullable: false),
                    ProductUnitType = table.Column<int>(type: "int", nullable: false),
                    PriceTotal = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    StockInDetailUnit = table.Column<decimal>(type: "decimal(18,3)", nullable: false),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Marka 1", new DateTime(2023, 6, 16, 16, 44, 35, 766, DateTimeKind.Local).AddTicks(6516), null, false, null },
                    { 2, "Marka 2", new DateTime(2023, 6, 16, 16, 44, 35, 766, DateTimeKind.Local).AddTicks(6518), null, false, null },
                    { 3, "Marka 3", new DateTime(2023, 6, 16, 16, 44, 35, 766, DateTimeKind.Local).AddTicks(6520), null, false, null },
                    { 4, "Marka 4", new DateTime(2023, 6, 16, 16, 44, 35, 766, DateTimeKind.Local).AddTicks(6521), null, false, null }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Kategori 1", new DateTime(2023, 6, 16, 16, 44, 35, 766, DateTimeKind.Local).AddTicks(6824), null, false, null },
                    { 2, "Kategori 2", new DateTime(2023, 6, 16, 16, 44, 35, 766, DateTimeKind.Local).AddTicks(6827), null, false, null },
                    { 3, "Kategori 3", new DateTime(2023, 6, 16, 16, 44, 35, 766, DateTimeKind.Local).AddTicks(6829), null, false, null },
                    { 4, "Kategori 4", new DateTime(2023, 6, 16, 16, 44, 35, 766, DateTimeKind.Local).AddTicks(6831), null, false, null }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2023, 6, 16, 16, 44, 35, 766, DateTimeKind.Local).AddTicks(6862), null, false, "Adres 11", "Adres 21", "Yönetici 1", "Tedarikçi 1", "Firma hakkında 1", "Phone 11", "Phone 21", "Vergi Dairesi 1", "Vergi Numarası 1", null },
                    { 2, new DateTime(2023, 6, 16, 16, 44, 35, 766, DateTimeKind.Local).AddTicks(6864), null, false, "Adres 21", "Adres 22", "Yönetici 2", "Tedarikçi 2", "Firma hakkında 2", "Phone 21", "Phone 22", "Vergi Dairesi 2", "Vergi Numarası 2", null },
                    { 3, new DateTime(2023, 6, 16, 16, 44, 35, 766, DateTimeKind.Local).AddTicks(6867), null, false, "Adres 31", "Adres 23", "Yönetici 3", "Tedarikçi 3", "Firma hakkında 3", "Phone 31", "Phone 23", "Vergi Dairesi 3", "Vergi Numarası 3", null },
                    { 4, new DateTime(2023, 6, 16, 16, 44, 35, 766, DateTimeKind.Local).AddTicks(6869), null, false, "Adres 41", "Adres 24", "Yönetici 4", "Tedarikçi 4", "Firma hakkında 4", "Phone 41", "Phone 24", "Vergi Dairesi 4", "Vergi Numarası 4", null }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2023, 6, 16, 16, 44, 35, 766, DateTimeKind.Local).AddTicks(6924), null, false, null, "Depo 1" },
                    { 2, new DateTime(2023, 6, 16, 16, 44, 35, 766, DateTimeKind.Local).AddTicks(6926), null, false, null, "Depo 2" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1, 1, new DateTime(2023, 6, 16, 16, 44, 35, 766, DateTimeKind.Local).AddTicks(6899), null, false, "12345", "PR001", "Ürün açıklaması 1", "Ürün 1", 10m, 0, 18, null },
                    { 2, 2, 2, new DateTime(2023, 6, 16, 16, 44, 35, 766, DateTimeKind.Local).AddTicks(6902), null, false, "12345", "PR002", "Ürün açıklaması 2", "Ürün 2", 20m, 0, 8, null },
                    { 3, 3, 3, new DateTime(2023, 6, 16, 16, 44, 35, 766, DateTimeKind.Local).AddTicks(6905), null, false, "12345", "PR003", "Ürün açıklaması 3", "Ürün 3", 30m, 0, 1, null },
                    { 4, 4, 4, new DateTime(2023, 6, 16, 16, 44, 35, 766, DateTimeKind.Local).AddTicks(6908), null, false, "12345", "PR004", "Ürün açıklaması 4", "Ürün 4", 40m, 0, 8, null }
                });
