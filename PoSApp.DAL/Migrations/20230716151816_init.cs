        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProductArrivalPrice = table.Column<decimal>(type: "decimal(18,4)", nullable: false),
                    ProductDiscountPercentage = table.Column<decimal>(type: "decimal(18,4)", nullable: false),
                    ProductUnitDiscountAmount = table.Column<decimal>(type: "decimal(18,4)", nullable: false),
                    ProductTotalDiscountAmount = table.Column<decimal>(type: "decimal(18,4)", nullable: false),
                    ProductTotalVatAmount = table.Column<decimal>(type: "decimal(18,4)", nullable: false),
                    ProductLastPriceWithoutVat = table.Column<decimal>(type: "decimal(18,4)", nullable: false),
                    ProductLastPriceWithVat = table.Column<decimal>(type: "decimal(18,4)", nullable: false),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Marka 1", new DateTime(2023, 7, 16, 18, 18, 16, 740, DateTimeKind.Local).AddTicks(647), null, false, null },
                    { 2, "Marka 2", new DateTime(2023, 7, 16, 18, 18, 16, 740, DateTimeKind.Local).AddTicks(648), null, false, null },
                    { 3, "Marka 3", new DateTime(2023, 7, 16, 18, 18, 16, 740, DateTimeKind.Local).AddTicks(650), null, false, null },
                    { 4, "Marka 4", new DateTime(2023, 7, 16, 18, 18, 16, 740, DateTimeKind.Local).AddTicks(652), null, false, null }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Kategori 1", new DateTime(2023, 7, 16, 18, 18, 16, 740, DateTimeKind.Local).AddTicks(828), null, false, null },
                    { 2, "Kategori 2", new DateTime(2023, 7, 16, 18, 18, 16, 740, DateTimeKind.Local).AddTicks(830), null, false, null },
                    { 3, "Kategori 3", new DateTime(2023, 7, 16, 18, 18, 16, 740, DateTimeKind.Local).AddTicks(832), null, false, null },
                    { 4, "Kategori 4", new DateTime(2023, 7, 16, 18, 18, 16, 740, DateTimeKind.Local).AddTicks(834), null, false, null }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2023, 7, 16, 18, 18, 16, 740, DateTimeKind.Local).AddTicks(858), null, false, "Adres 11", "Adres 21", "Yönetici 1", "Tedarikçi 1", "Firma hakkında 1", "Phone 11", "Phone 21", "Vergi Dairesi 1", "Vergi Numarası 1", null },
                    { 2, new DateTime(2023, 7, 16, 18, 18, 16, 740, DateTimeKind.Local).AddTicks(860), null, false, "Adres 21", "Adres 22", "Yönetici 2", "Tedarikçi 2", "Firma hakkında 2", "Phone 21", "Phone 22", "Vergi Dairesi 2", "Vergi Numarası 2", null },
                    { 3, new DateTime(2023, 7, 16, 18, 18, 16, 740, DateTimeKind.Local).AddTicks(863), null, false, "Adres 31", "Adres 23", "Yönetici 3", "Tedarikçi 3", "Firma hakkında 3", "Phone 31", "Phone 23", "Vergi Dairesi 3", "Vergi Numarası 3", null },
                    { 4, new DateTime(2023, 7, 16, 18, 18, 16, 740, DateTimeKind.Local).AddTicks(866), null, false, "Adres 41", "Adres 24", "Yönetici 4", "Tedarikçi 4", "Firma hakkında 4", "Phone 41", "Phone 24", "Vergi Dairesi 4", "Vergi Numarası 4", null }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2023, 7, 16, 18, 18, 16, 740, DateTimeKind.Local).AddTicks(925), null, false, null, "Depo 1" },
                    { 2, new DateTime(2023, 7, 16, 18, 18, 16, 740, DateTimeKind.Local).AddTicks(927), null, false, null, "Depo 2" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1, 1, new DateTime(2023, 7, 16, 18, 18, 16, 740, DateTimeKind.Local).AddTicks(899), null, false, "12345", "PR001", "Ürün açıklaması 1", "Ürün 1", 10m, 0, 18, null },
                    { 2, 2, 2, new DateTime(2023, 7, 16, 18, 18, 16, 740, DateTimeKind.Local).AddTicks(902), null, false, "12345", "PR002", "Ürün açıklaması 2", "Ürün 2", 20m, 0, 8, null },
                    { 3, 3, 3, new DateTime(2023, 7, 16, 18, 18, 16, 740, DateTimeKind.Local).AddTicks(905), null, false, "12345", "PR003", "Ürün açıklaması 3", "Ürün 3", 30m, 0, 1, null },
                    { 4, 4, 4, new DateTime(2023, 7, 16, 18, 18, 16, 740, DateTimeKind.Local).AddTicks(908), null, false, "12345", "PR004", "Ürün açıklaması 4", "Ürün 4", 40m, 0, 8, null }
                });
